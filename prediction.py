...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.accountTypeGroupBox.setTitle(_translate("Dialog", "Output"))
        self.tickerLabel.setText(_translate("Dialog", "The whole results can be saved:"))
